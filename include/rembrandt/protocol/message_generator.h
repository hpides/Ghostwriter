...
class MessageGenerator {
 public:
  ...
  std::unique_ptr<Message> StageRequest(Batch *batch);
  ...
  std::unique_ptr<Message> StageResponse(uint64_t offset, const Rembrandt::Protocol::BaseMessage &stage_request);
 private:
