...
class EndpointFactory {
 ...
 private:
  static struct sockaddr_in6 CreateConnectionAddress(const std::string &address, uint16_t port);
  static ucp_ep_params_t CreateParams(struct sockaddr_in6 &connect_addr);
};
}
