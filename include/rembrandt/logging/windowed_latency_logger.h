#ifndef REMBRANDT_SRC_LOGGING_WINDOWED_LATENCY_LOGGER_H_
#define REMBRANDT_SRC_LOGGING_WINDOWED_LATENCY_LOGGER_H_
...
class WindowedLatencyLogger {
 public:
  WindowedLatencyLogger(long batch_count, long window_size);
...
#endif //REMBRANDT_SRC_LOGGING_WINDOWED_LATENCY_LOGGER_H_
