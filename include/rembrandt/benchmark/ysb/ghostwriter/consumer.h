#ifndef REMBRANDT_INCLUDE_REMBRANDT_BENCHMARK_YSB_GW_CONSUMER_H_
#define REMBRANDT_INCLUDE_REMBRANDT_BENCHMARK_YSB_GW_CONSUMER_H_
...
class YSBGWConsumer {
 public:
  YSBGWConsumer(int argc, char *const *argv);
  void Run();
...
#endif //REMBRANDT_INCLUDE_REMBRANDT_BENCHMARK_YSB_GW_CONSUMER_H_
